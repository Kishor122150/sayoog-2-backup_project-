...
?>
    <style>
      ...
      .vol-modal-overlay { display:none; position:fixed; inset:0; z-index:1050; background:rgba(0,0,0,0.6); backdrop-filter:blur(10px); -webkit-backdrop-filter:blur(10px); align-items:center; justify-content:center; padding:24px; animation:volModalFadeIn 0.2s ease; }
      ...
      /* ── Modal Section Styles (Missing CSS fixes) ── */
